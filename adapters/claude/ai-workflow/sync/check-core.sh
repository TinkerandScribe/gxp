#!/usr/bin/env bash
#
# check-core.sh for Claude adapter
#
# Compares the Claude AI Workflow adapter against the canonical methodology in core/.
# Lighter than Grok version since Claude adapter is primarily instructions-based.
#
# Usage:
...
if [ "$QUIET" != true ]; then
    echo ""
    echo "=== Claude AI Workflow Adapter — Core Sync Check (bash) ==="
